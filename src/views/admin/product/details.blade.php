...
<div class="page-bar">
  <ul class="page-breadcrumb">
    ...
    <li>
      <a href="{{ url('/meli/admin/products') }}">Products</a>
      <i class="fa fa-circle"></i>
    </li>
    <li>
      <span>Edit</span>
              ...
              <div class="tab-pane active" id="tab_general">
                <div class="form-body">
                  <div class="form-group">
                    ...
                    <div class="col-md-10">
                      <input type="text" class="form-control" name="product[name]" placeholder="" value="{{ $product->title }}">
                    </div>
                  </div>
                  <div class="form-group">
                    ...
                    <div class="col-md-10">
                      <textarea class="form-control" name="product[description]" value="{{ $product->subtitle }}"></textarea>
                    </div>
                  </div>
                  <div class="form-group">
                      ...
                      <div class="form-control height-auto">
                        <div class="scroller" style="height:275px;" data-always-visible="1">
                          <ul class="list-unstyled">
                            <li>
                              <label><input type="checkbox" name="product[categories][]" value="{{ $product->category_id }}"> {{ $product->category_id }} </label>
                            </li>
                          </ul>
                        </div>
                      </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-10">
                      <input type="text" class="form-control" name="product[sku]" placeholder="" value="{{ isset($product->seller_custom_field) ? $product->seller_custom_field : '' }}">
                    </div>
                  </div>
                  <div class="form-group">
                    ...
                    <div class="col-md-10">
                      <input type="text" class="form-control" name="product[price]" placeholder="" value="{{ number_format($product->price, 2) }}">
                    </div>
                  </div>
                  <div class="form-group">
                    ...
                    <div class="col-md-10">
                      <input type="text" class="form-control" name="product[price]" placeholder="" value="{{ number_format($product->base_price, 2) }}">
                    </div>
                  </div>
                  <div class="form-group">
                    ...
                    <div class="col-md-10">
                      <input type="text" class="form-control" name="product[price]" placeholder="" value="{{ number_format($product->original_price, 2) }}">
                    </div>
                  </div>
                  <div class="form-group">
                      ...
                      <td>
                        ...
                        <td>
                          ...
                          <td>
                            ...
                            <script src="{{ asset('angular/assets/global/plugins/plupload/js/plupload.full.min.js') }}" type="text/javascript"></script>
                            @endsection
                            @section('script')
                            ...
                            flash_swf_url: "{{ asset('angular/assets/plugins/plupload/js/Moxie.swf') }}",
